...
####
# verify default sort
function test_default_sort_default_column() {
    if [ $1 == 'expected' ]; then
	echo '01 B
01 C
02 A
...
execTest "test_default_sort_default_column"

####
# verify default sort
function test_default_sort_2nd_column() {
    if [ $1 == 'expected' ]; then
	echo '02 A
03 A
01 B
...
execTest "test_default_sort_2nd_column"
